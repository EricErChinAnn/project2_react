...
export default function Login(props) {
    if (props.loggedIn) {
        return (
            <React.Fragment>
                <div class="modal fade fontLust" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content ">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5 fontCinB" id="exampleModalLabel">Account</h1>
